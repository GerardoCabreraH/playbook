...
const areSomeTrue = explorers.some((my_explorer_in_list) =>  my_explorer_in_list.exercisesFinished === true)
console.log(areSomeTrue) //true

console.log("Ejercicio 2.8")
const areAllIsFinished = explorers.every((my_explorer_in_list) => typeof + my_explorer_in_list.isFinished === true) // every
